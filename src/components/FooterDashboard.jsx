...
export const FooterDashboard = ({ todo, onClearCompleteClick }) => {
  return (
    <li className="flex justify-between px-5 items-center text-base w-full h-14 text-center transition-all duration-400 font-semibold rounded-bl-lg rounded-br-lg md:hidden dark:bg-slate-700 dark:text-slate-200">
      <p>
